			...
			<div class="order-block">
				...
				<div class="block-content">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="email" placeholder="Укажите e-mail" v-model="email" :class="{'is-invalid': errors.email}">
						<span class="text-danger" v-if="errors.email">{{ errors.email[0] }}</span>
					</div>

					<div class="form-group">
						<label for="password">Пароль</label>
						<input type="text" class="form-control" id="password" placeholder="Придумайте пароль" v-model="password" :class="{'is-invalid': errors.password}">
